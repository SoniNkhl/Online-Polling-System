...
public class Cand_Find extends JFrame implements ActionListener,ItemListener{
	...
	Cand_Find(){
	    ...
	    JLabel image1 = new JLabel("Candidate Find",i3,SwingConstants.CENTER);
		...
		btnclear.setBounds(520,550,100,35);
		...
		btnclose.setBounds(730,550,100,35);
