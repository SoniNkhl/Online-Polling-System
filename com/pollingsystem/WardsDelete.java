...
public class WardsDelete extends JFrame implements ActionListener,ItemListener{
	...
	WardsDelete(){
	    ...
	    JLabel image1 = new JLabel("Ward Delete",i3,SwingConstants.CENTER);
    	...
    	setVisible(true);
   	    setDefaultCloseOperation(DISPOSE_ON_CLOSE);
			...
			// TODO Auto-generated method stub
					...
					{
						if (txtwardnm.getText().length()==0 || txtdesc.getText().length()==0)
						{
						...
						try {
							...
							String sql="delete from Wards where Wardno=?";
