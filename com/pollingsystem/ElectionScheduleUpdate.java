...
public class ElectionScheduleUpdate extends JFrame implements ActionListener,ItemListener{
   ...
   JComboBox cb;
	ResultSet rs;
		    ...
		    ElectionScheduleUpdate(){
			    ...
			    JLabel image1 = new JLabel("Election Schedule Update",i3,SwingConstants.CENTER);
		...
		// TODO Auto-generated method stub
				//txtcandid,txtwardno,txtdoe,txtpnm
				if(ae.getSource()==btnupdate)
				{
					try {
						...
						String sql="update Electionschedule set Candidateid=?,Wardno=?,Dateofelection=?  where Electionid=?";
						
								st=con.prepareStatement(sql);
								st.setString(1,txtcandid.getText());
								st.setString(2,txtwardno.getText());
								st.setString(3,txtdoe.getText());
								st.setString(4,cb.getSelectedItem().toString());
